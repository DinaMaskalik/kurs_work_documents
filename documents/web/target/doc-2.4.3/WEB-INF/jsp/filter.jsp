...
<script>
    ...
    autocomplete(document.getElementById("author"), ${author});
    autocomplete(document.getElementById("whoCreate"), ${whoCreate});
    <%--autocomplete(document.getElementById("withWhom"), ${withWhom});--%>
</script>